...
document.querySelector('.carrusel-btn-prev').addEventListener('click', function() {
  currentItem = (currentItem - 1 + carruselItems.length) % carruselItems.length;
  showItem(currentItem);
});

document.querySelector('.carrusel-btn-next').addEventListener('click', function() {
